...
O projeto utiliza dados públicos oficiais do Ministério da Saúde/DATASUS e integra um dashboard publicado no Power BI por meio de iframe público.
...
Este projeto foi desenvolvido como parte da **Atividade Extensionista I** do curso **CST em Ciência de Dados — UNINTER**.
...
Os dados utilizados neste projeto são públicos e foram obtidos a partir de bases oficiais do **Ministério da Saúde/DATASUS**, considerando a cobertura vacinal por município de residência.
